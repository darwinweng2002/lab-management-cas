...
$.fn.dataTable.ext.errMode = 'throw'; // Show detailed errors

    var table_inventory_pulledout = $('.table_inventory_pulledout').DataTable({
      ajax: {
        url: 'display.php', // ✅ this file simulates your backend
        type: 'POST',
        data: {
        ...
        },
        {
          ...
          customize: function(win) {
            $(win.document.body).find('table')
              .append('<br><br><h4>Noted by:</h4><br><br><h4>Prepared by:</h4>');
          }
        }
      ]
    });
    ...
    },
    {
      ...
      customize: function (win) {
        $(win.document.body).find('table').append(
          `<br><br><br><br><h4>Noted by:</h4><br><br><br><br><br><h4>Prepared by:</h4>`
        );
      }
    }
  ]
	...
	"ajax":
		...
		buttons: [
			...
			},
			{
				...
				customize: function ( win ) {
					$(win.document.body).find( 'table' ).append('<br<br/><br><br><br><h4 class="">Noted by:</h4><br><br><br><br><br><h4 class="">Prepared by: KATRINA E. PAJELA</h4>');
				}
			}
		]
});
