...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				<td><img src="../views/logo.png" class="img-responsive" /></td>
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">PRESIDENT RAMON MAGSAYSAY STATE UNIVERSITY</p>
					<p style="margin:0;padding:0;font-weight:bold;">COLLEGE OF ARTS AND SCIENCES</p>
					<p style="margin:0;padding:0;">Iba, Zambales, Philippines</p>
				</td>
				<td><img src="../views/logo.png" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
