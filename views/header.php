...
<body class="">
    ...
    <img src="../assets/custom/img/logo.png" alt="Logo" style="height:30px; display:inline-block; margin-right:10px; vertical-align: middle;">
    CAS LABORATORY MANAGEMENT SYSTEM
  </a>
				<ul class="user-menu">
